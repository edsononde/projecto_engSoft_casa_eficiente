 ...
 * @author edson
 */
public class TelaGestorTecnicoCadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TELA DE CADASTRO DE TÉCNICO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGestorTecnicoCadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaGestorTecnicoCadastro().setVisible(true);
            }
        });
    }
