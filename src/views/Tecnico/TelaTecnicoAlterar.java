 ...
 * @author edson
 */
public class TelaTecnicoAlterar extends javax.swing.JFrame {

    /**
     * Creates new form TelaClienteCadastro
     */
    public TelaTecnicoAlterar() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTecnicoAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaTecnicoAlterar().setVisible(true);
            }
        });
    }
