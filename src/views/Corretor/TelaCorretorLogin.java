 ...
 * @author Jason Matias
 */
public class TelaCorretorLogin extends javax.swing.JFrame {

    /**
     * Creates new form TelaLoginCliente
     */
    public TelaCorretorLogin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCorretorLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCorretorLogin().setVisible(true);
            }
        });
    }
